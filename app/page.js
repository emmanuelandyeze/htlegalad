...
export default function Home() {
	return (
		<div>
			<div className="flex flex-col lg:flex-row max-w-7xl mx-auto items-center lg:justify-between h-[100vh] pt-40 lg:pt-28 lg:pb-10  p-4">
				<div className="flex lg:hidden p-2 absolute bottom-0 justify-center">
					<Image
				...
				<div className="text-left z-20 flex flex-col justify-between items-start lg:text-left lg:border-t-2 max-w-xl pt-0 pb-0 lg:py-10 lg:mr-10 mb-8">
					<h1 className=" text-4xl text-secondaryText lg:text-5xl leading-[3.2rem] lg:leading-[3.5rem] font-semibold mb-4 lg:mb-8">
