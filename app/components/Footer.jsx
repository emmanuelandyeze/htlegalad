...
export default function Footer() {
  return (
		<footer className="bg-white max-w-7xl mx-auto text-black py-10 px-6 md:px-20 lg:px-32 flex flex-col md:flex-row justify-between w-[100%] items-end md:items-center text-center md:text-left">
			{/* Left Section */}
			<div className=" flex flex-col items-center md:items-start">
				<Image
					src={'/images/flogo.jpeg'}
					alt="HT Legal logo"
					width={160}
					height={160}
				...
				<p className="text-sm text-gray-600">
					corporate commercial law | contract management |
					legal advisory
				</p>
			...
			<div className="flex flex-col justify-between md:h-[35vh] md:items-end">
				<div className="hidden md:flex flex-col">
					<p className="md:text-3xl text-[#7777]">
						Safeguarding your today,
					</p>
					<p className="md:text-3xl text-[#051D40]">
				...
				<div className=" mt-6 md:mt-10 flex flex-col items-center md:items-end gap-3 md:mb-10">
					...
					<p className="text-sm">
						Finbarrs Rd, Akoka, Lagos, NG.
					</p>
					<p className="text-sm">
						Akala Express-Way, Ibadan, NG.
					</p>
				</div>
